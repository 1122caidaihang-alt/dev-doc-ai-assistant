...
> 来源: https://doc.iocoder.cn/new-feature/admin-uniapp

- [](/)
 - 开发指南
- 后端手册
 [芋道源码](https://www.iocoder.cn) [2026-01-02](javascript:;)   目录  
# 代码生成（移动端）
...
现在，我们将在 yudao-ui-admin-uniapp
 
 (opens new window) 项目中，生成移动端的【用户组】功能。
