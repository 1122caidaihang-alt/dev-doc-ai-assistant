...
> 来源: https://doc.iocoder.cn/message-queue/rocketmq

- [](/)
 - 开发指南
- 中间件手册
 [芋道源码](https://www.iocoder.cn) [2023-11-02](javascript:;)   目录  
# 消息队列（RocketMQ）
...
`yudao-spring-boot-starter-mq`
 ...
 (opens new window) 技术组件，基于 RocketMQ 实现分布式消息队列。
 
如果你对 RocketMQ 不太了解，可以看看 《芋道 Spring Boot 消息队列 RocketMQ 入门》
...
dependency>
    ...
    artifactId>yudao-spring-boot-starter-mqartifactId>
dependency>
...
public class SmsSendMessage {
     ...
     * 短信模板参数
     */
    private ListKeyValueString, Object>> templateParams;
...
public class SmsProducer {
    ...
    public void sendSmsSendMessage(Long logId, String mobile,
                                   Long channelId, String apiTemplateId, ListKeyValueString, Object>> templateParams) {
...
@Slf4j
public class SmsSendConsumer implements RocketMQListenerSmsSendMessage> { // 重点：实现 RocketMQListener 类，并填写对应的 Message 类
