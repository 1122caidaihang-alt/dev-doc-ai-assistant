...
> 来源: https://doc.iocoder.cn/message-queue/redis
...
`yudao-spring-boot-starter-mq`
 ...
 (opens new window) 特性，提供【集群】消费的能力。
 - 使用 Pub/Sub
 
 (opens new window) 特性，提供【广播】消费的能力。
...
集群消费在项目中的使用场景，主要是提供可靠的、可堆积的异步任务的能力。例如说：
 ...
 (opens new window)发送短信。
 - 邮件模块，使用它异步
 
 (opens new window)发送邮件。
...
@Component
@Slf4j
public class SmsSendConsumer extends AbstractRedisStreamMessageListenerSmsSendMessage> { // 重点：继承 AbstractRedisStreamMessageListener 类，并填写对应的 Message 类
