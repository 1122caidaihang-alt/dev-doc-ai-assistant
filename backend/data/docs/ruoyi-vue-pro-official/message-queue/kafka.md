...
> 来源: https://doc.iocoder.cn/message-queue/kafka
...
`yudao-spring-boot-starter-mq`
 ...
 (opens new window) 技术组件，基于 Kafka 实现分布式消息队列。
 
如果你对 Kafka 不太了解，可以看看 《芋道 Spring Boot 消息队列 Kafka 入门》
...
public class SmsProducer {
    ...
    @Resource
    private KafkaTemplateObject, Object> kafkaTemplate; // 重点：注入 KafkaTemplate 对象
