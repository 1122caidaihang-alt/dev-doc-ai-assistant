...
> 来源: https://doc.iocoder.cn/api-doc
...
*【推荐】 Apifox
 ...
 (opens new window)：强大的 API 工具，支持 API 文档、API 调试、API Mock、API 自动化测试
...
如果你没有学习 Swagger，可以阅读 《芋道 Spring Boot API 接口文档 Swagger 入门 》
...
浏览器访问 http://127.0.0.1:48080/doc.html
 
 (opens new window) 地址，使用 Knife4j 查看 API 接口文档。
...
① 在 `yudao-spring-boot-starter-web`
 
 (opens new window) 技术组件的 `swagger`
 
 (opens new window) 包，实现了对 Swagger 的封装。
