...
> 来源: https://doc.iocoder.cn/deployment-docker

- [](/)
 - 开发指南
- 运维手册
 [芋道源码](https://www.iocoder.cn) [2022-04-13](javascript:;)   目录  
# Docker 部署
...
执行如下命令，进行 Docker 的安装。参考自 https://help.aliyun.com/zh/ecs/use-cases/install-and-use-docker-on-a-linux-ecs-instance
...
④ 请求 http://139.9.196.247:48080
 
 (opens new window) 地址（“需要换成你的外网 IP”），成功访问前端项目的外网地址，，返回前端界面如下：
