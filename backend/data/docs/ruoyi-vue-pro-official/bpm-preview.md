...
> 来源: https://doc.iocoder.cn/bpm-preview
...
### # 1.1 BPM 管理后台
 ...
 (opens new window) 的 `bpm` 目录，基于 Vue3 + Element Plus 实现
...
支持 Spring Boot 单体、Spring Cloud 微服务架构
 ...
 (opens new window) 的 `yudao-module-bpm` 模块
 - 微服务仓库： https://github.com/YunaiV/yudao-cloud
 
 (opens new window) 的 `yudao-module-bpm` 服务
