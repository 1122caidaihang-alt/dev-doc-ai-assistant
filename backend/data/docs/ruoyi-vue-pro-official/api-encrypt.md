...
> 来源: https://doc.iocoder.cn/api-encrypt

- [](/)
 - 开发指南
- 后端手册
 [芋道源码](https://www.iocoder.cn) [2025-08-16](javascript:;)   目录  
# HTTP 接口加解密
...
当然，你也可以使用 http://web.chacuo.net/netrsakeypair
...
export async function loginApi(data: AuthApi.LoginParams) {
  return requestClient.postAuthApi.LoginResult>('/system/auth/login', data, {
    headers: {
      isEncrypt: true,
    },
  });
...
参见 《Java 解密 AES-256 失败，秘钥长度受限制问题》
 ...
 (opens new window)
    ...
    [HTTP 接口签名（防篡改）](/http-sign/) [单元测试](/unit-test/) 
