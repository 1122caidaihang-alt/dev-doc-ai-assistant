...
> 来源: https://doc.iocoder.cn/bpm/dameng

- [](/)
 - 开发指南
- 工作流手册
 [芋道源码](https://www.iocoder.cn) [2023-11-26](javascript:;)   目录  
# 工作流（达梦适配）
...
本文参考 《Flowable6.8(6.x 版本通用)整合集成达梦 8 数据库(DM8)详解，解决自动生成表时 dmn 相关表语法报错问题》
 
 (opens new window) 博客，由开发者（微信号 `barry82`）所贡献！
...
如果你是 `master-jdk17` 分支，需要额外参考 https://t.zsxq.com/sXvQ8
 
 (opens new window) 文档，保持耐心~
 
另外，也可以直接合并 https://gitee.com/zhijiantianya/ruoyi-vue-pro/tree/master-dm8-jdk17
 
 (opens new window) 分支，已经验证过。
