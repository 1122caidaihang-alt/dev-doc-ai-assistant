...
> 来源: https://doc.iocoder.cn/module-new
...
project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    parent>
        ...
        artifactId>yudaoartifactId>
        version>${revision}version> 
    parent>
    modelVersion>4.0.0modelVersion>
    artifactId>yudao-module-demoartifactId>
    ...
    dependencies>  
        ...
        dependency>
            groupId>cn.iocoder.bootgroupId>
            artifactId>yudao-spring-boot-starter-webartifactId>
        dependency>

        dependency>
            groupId>cn.iocoder.bootgroupId>
            artifactId>yudao-spring-boot-starter-securityartifactId>
        dependency>

        
        dependency>
            groupId>cn.iocoder.bootgroupId>
            artifactId>yudao-spring-boot-starter-mybatisartifactId>
        dependency>

        
        dependency>
            groupId>cn.iocoder.bootgroupId>
            artifactId>yudao-spring-boot-starter-testartifactId>
        dependency>
    dependencies>
...
使用浏览器打开 http://127.0.0.1:48080/doc.html
 
 (opens new window) 地址，进入 Swagger 接口文档。
...
如果不是，修改 YudaoServerApplication
 
 (opens new window) 类，增加新建的模块的 `package` 包名。例如说：
