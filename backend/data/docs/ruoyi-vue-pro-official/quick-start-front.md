...
> 来源: https://doc.iocoder.cn/quick-start-front

- [](/)
 - 开发指南
- 萌新必读
 [芋道源码](https://www.iocoder.cn) [2023-03-05](javascript:;)   目录  
# 快速启动（前端项目）
...
目标：将项目 ruoyi-vue-pro
 
 (opens new window) 的前端项目运行起来 🛫
...
项目的管理后台有 4 个版本：
 ...
 (opens new window)：基于 Vue3 + element-plus
 - `yudao-ui-admin-vben`
 
 (opens new window)：基于 Vue3 + vben5(ant-design-vue)
 - `yudao-ui-admin-vue2`
 
 (opens new window)：基于 Vue2 + element-ui
 - `yudao-ui-admin-uniapp`
 
 (opens new window)：基于 Vue3 + uni-app
...
① 克隆 https://github.com/yudaocode/yudao-ui-admin-vue3.git
 
 (opens new window) 项目，并 Star 关注下该项目。
...
详细说明，可见 《为什么有人说 Vite 快，有人却说 Vite 慢？》
...
`yudao-ui-admin-vben`
 ...
 (opens new window) 是前端 Vue3 + vben5(ant-design-vue、element-plus) 管理后台项目。
 
① 克隆 https://github.com/yudaocode/yudao-ui-admin-vben.git
...
③ 启动完成后，浏览器会自动打开 http://localhost:5666
 
 (opens new window) 或 http://localhost:5777
...
① 克隆 https://github.com/yudaocode/yudao-ui-admin-vue2.git
...
② 启动完成后，浏览器会自动打开 http://localhost:1024
...
① 克隆 https://github.com/yudaocode/yudao-ui-admin-uniapp.git
...
③ 启动完成后，浏览器会自动打开 http://localhost:9000
...
另外，也可以阅读下 HBuilder 的官方文档 https://zh.uniapp.dcloud.io/quickstart-hx.html
 
 (opens new window) 的「运行 uni-app」小节。
 
① 克隆 https://github.com/yudaocode/yudao-mall-uniapp
 
 (opens new window) 项目，并 Star 关注下该项目。
 
② 下载 HBuilder
 
 (opens new window) 工具，并进行安装。
...
如果你没有微信小程序的 AppID，可以参考 https://developers.weixin.qq.com/miniprogram/dev/devtools/sandbox.html
 
 (opens new window) 申请一个测试号。
