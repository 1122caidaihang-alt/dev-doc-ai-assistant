...
> 来源: https://doc.iocoder.cn/pay/wx-pub-pay-demo
...
友情提示：
 - http://niubi.natapp1.cc
 
 (opens new window) 域名，是我前端项目的访问域名
 - http://yunai.natapp1.cc
 
 (opens new window) 域名，是我后端项目的访问域名
...
① 访问 [支付管理 -> 应用信息] 菜单，点击“商城应用”对应的【微信 JSAPI 支付】，进入支付渠道的配置。如下图所示：
 ...
 - 在 https://pay.weixin.qq.com/index.php/core/account/info
 
 (opens new window) 地址，可获取微信支付商户号
 - 在 https://pay.weixin.qq.com/index.php/core/cert/api_cert#/
 
 (opens new window) 地址，可获取 API 证书、密钥
 
友情提示：
 
可以简单阅读下 《微信官方文档 —— JSAPI 支付的接入前准备》
...
如果使用 V2 版本，最好参考 https://gitee.com/zhijiantianya/yudao-cloud/issues/ICY1MT
 
 (opens new window) 帖子，降低 `weixin-java` 组件的版本。
 
② 访问微信支付的 开发配置
 
 (opens new window) 地址，设置 JSAPI 支付目录，设置为前端项目的访问域名。如下图所示：
