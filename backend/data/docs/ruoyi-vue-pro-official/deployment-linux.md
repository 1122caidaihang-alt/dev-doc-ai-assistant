...
> 来源: https://doc.iocoder.cn/deployment-linux

- [](/)
 - 开发指南
- 运维手册
 [芋道源码](https://www.iocoder.cn) [2022-04-12](javascript:;)   目录  
# Linux 部署
...
原因和解决，参考 https://www.cnblogs.com/niceyoo/p/11545196.html
...
创建一个名字为 `ruoyi-vue-pro` 数据库，执行数据库对应的 `sql`
 
 (opens new window) 目录下的 SQL 文件，进行初始化。
...
参考 Nginx 官方文档
 ...
 (opens new window)，安装 Nginx 服务。命令如下：
...
脚本的详细讲解，可见 《芋道 Jenkins 极简入门 》
 
 (opens new window) 的「2.3 远程服务器配置 」小节。
